...
from utils import retain_edges, remove_edges
...
def level_for_2(features, n_nodes, feat_dim, adj_orig, dir_train_info, dir_train_result, positive_edges_all, negative_edges_all):
...
def gae_for(args):
    ...
    for m in range(1, replicate_num + 1):
        ...
        p = Process(target=level_for_2, args=(features,n_nodes,feat_dim,adj_orig,dir_train_info,dir_train_result,positive_edges_all,negative_edges_all,))
        p.start()
        pool.append(p)
